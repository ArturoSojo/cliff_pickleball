class SliderData {
  static List<dynamic> content = [
    {
      "title": "Welcome To CliffPickleball",
      "subtitle":
          "A Private, Secure, End-to-End Encrypted Messaging app that helps you to connect with your connections without any Ads, promotion. No other third party person, organization, or even CliffPickleball Team can't read your messages.",
    },
    {
      "title": "Communicate With Security",
      "subtitle":
          "Chat Messages are End-to-End-Encrypted. No-other third party app or CliffPickleball Team can't read your messages.",
    },
    {
