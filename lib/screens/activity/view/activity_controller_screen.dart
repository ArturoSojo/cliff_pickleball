...
import 'package:cliff_pickleball/model/activity_model.dart';
import 'package:cliff_pickleball/providers/activity/activity_screen_provider.dart';
import 'package:cliff_pickleball/providers/activity/poll_show_provider.dart';
import 'package:cliff_pickleball/providers/status_collection_provider.dart';
import 'package:cliff_pickleball/screens/activity/view/activity_value_screen.dart';
...
import 'package:cliff_pickleball/screens/activity/animation_controller.dart';
...
class _ActivityControllerState extends State<ActivityController>
  ...
  _sendActivityReplyMsg(ActivityModel? _currentActivityData) async {
    ...
    ToastMsg.showSuccessToast('Reply Send Successfully', context: context);
  }
}
