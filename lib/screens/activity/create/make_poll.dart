...
import 'package:cliff_pickleball/providers/activity/poll_creator_provider.dart';
...
class _PollCreatorScreenState extends State<PollCreatorScreen> {
  ...
  _commonTextField(
    ...
    return Container(
      ...
      child: TextFormField(
        cursorColor:
            _isDarkMode ? AppColors.pureWhiteColor : AppColors.pureBlackColor,
        ...
        decoration: InputDecoration(
          labelText: labelText,
          labelStyle: TextStyleCollection.activityTitleTextStyle.copyWith(
              color: _isDarkMode
                  ? AppColors.pureWhiteColor.withOpacity(0.6)
                  : AppColors.pureBlackColor.withOpacity(0.6)),
