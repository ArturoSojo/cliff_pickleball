...
import 'package:cliff_pickleball/screens/settings/chat_wallpaper/chat_wallpaper_preview.dart';
...
class _ChatWallpaperScreenState extends State<ChatWallpaperScreen> {
          ...
          : Container(
              ...
              child: GridView(
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    mainAxisSpacing: 20,
                    crossAxisSpacing: 20,
                    childAspectRatio: MediaQuery.of(context).size.width / 430),
                children: [
  ...
  void _deleteOldGlobalChatWallpaper() async {
    if (widget.contentFor == ContentFor.global) {
      ...
      Provider.of<ChatBoxMessagingProvider>(context, listen: false)
          .getChatWallpaperData(_partnerId);
    }
