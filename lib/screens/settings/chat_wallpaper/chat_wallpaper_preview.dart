...
class _ChatWallpaperPreviewState extends State<ChatWallpaperPreview> {
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          _commonMessageLayout(
              leftAligned: false,
              textMsg: "Set Common Wallpaper For CliffPickleball",
              top: 80),
  ...
  void _setManualWallpaper(image) async {
    ...
    if (widget.contentFor == ContentFor.global) {
      ...
      Provider.of<ChatBoxMessagingProvider>(context, listen: false)
          .getChatWallpaperData(_partnerUserId, newWallpaper: _imageToStore);
    }

    ToastMsg.showSuccessToast("Chat Wallpaper Set Successfully",
        context: context);
