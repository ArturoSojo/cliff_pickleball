...
import 'package:cliff_pickleball/screens/settings/support/donate_screen.dart';
import 'package:cliff_pickleball/screens/settings/support/send_email_to_support.dart';
...
class SupportScreen extends StatelessWidget {
  ...
  _submitProblem(BuildContext context) {
    ...
    return ListTile(
      ...
      subtitle: Text(
        'Let us know what problem you are facing in this app, so that we can resolve it',
        style: TextStyleCollection.terminalTextStyle.copyWith(
            color: _isDarkMode
