...
import 'package:cliff_pickleball/auth/google_auth.dart';
import 'package:cliff_pickleball/screens/entry_screens/sign_in_screen.dart';
...
class _IntroScreensState extends State<IntroScreens> {
  ...
  void _googleSignIn() async {
    ...
    if (_userData == null) {
      ToastMsg.showErrorToast("Sign In Failed", context: context);
    ...
    ToastMsg.showSuccessToast("Sign In Successful", context: context);
