...
import 'package:cliff_pickleball/config/regex_collection.dart';
import 'package:cliff_pickleball/db_operations/firestore_operations.dart';
import 'package:cliff_pickleball/screens/entry_screens/information_taking.dart';
import 'package:cliff_pickleball/screens/entry_screens/sign_up_screen.dart';
...
import 'package:cliff_pickleball/auth/email_auth.dart';
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  void _onSubmitInformation() async {
    ...
    if (_data["success"]) {
      ToastMsg.showSuccessToast(_data["message"], context: context);
    } else {
      ToastMsg.showErrorToast(_data["message"], context: context);
    }
