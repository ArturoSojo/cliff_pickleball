...
import 'package:cliff_pickleball/screens/settings/chat_wallpaper/chat_wallpaper_category_screen.dart';
import 'package:cliff_pickleball/screens/settings/inner_settings.dart';
import 'package:cliff_pickleball/screens/settings/support/support_management.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  _themeManager() {
    ...
    return Theme(
      data:
          Theme.of(context).copyWith(dividerColor: AppColors.transparentColor),
      child: ExpansionTile(
        backgroundColor: AppColors.getBgColor(_isDarkMode),
        leading: Icon(
