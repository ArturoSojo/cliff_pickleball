...
import 'package:cliff_pickleball/services/show_google_map.dart';
    ...
    return GestureDetector(
      onHorizontalDragEnd: (details) {
        if (details.primaryVelocity! > 0) {
          _rightSwipe(messageId, messageData, _msgHolderId);
        }
      },
      child: InkWell(
        onTap: () => onMessageTap(
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Text(
              "Messages are End-to-End Encrypted.\nNo other Third Party Person, Organization or even CliffPickleball Team can't read your messages",
