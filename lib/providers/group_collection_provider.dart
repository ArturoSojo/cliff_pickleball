...
class GroupCollectionProvider extends ChangeNotifier {
  ...
  List<dynamic> _groupDataCollection = [
    {
      ...
      "latestMessage": {
        ...
        "message":
            "Hey Sexy, What's up?? https://www.Rock Lifedasgupta.com/static/media/Rock Life_dasgupta.48a013aa.png",
        "time": "26 July",
        "holderId": "45",
        "holderName": "Sukannya",
      },
  ...
  addNewData(incomingNewData) {
    ...
    _groupDataCollection = [..._groupDataCollection, ...incomingNewData];
    notifyListeners();
  }
