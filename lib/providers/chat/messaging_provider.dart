...
import 'package:cliff_pickleball/db_operations/config.dart';
import 'package:cliff_pickleball/db_operations/types.dart';
...
import 'package:cliff_pickleball/providers/network_management_provider.dart';
import 'package:cliff_pickleball/services/directory_management.dart';
...
//  Map<String, dynamic> _partnerData = {};
  ...
  getMessagesRealtime(String incomingPartnerUserId) {
    _realTimeMessagingSubscription = _realTimeOperations
        .getChatMessages(incomingPartnerUserId)
        .listen((docSnapShot) {
