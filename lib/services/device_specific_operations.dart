...
class NotificationManagement {
  ...
  Future<void> _initAll(InitializationSettings initializationSettings) async {
  ...
  showNotification(
    ...
    try {
      ...
      final AndroidNotificationDetails androidDetails =
        ...
        "FLUTTER_NOTIFICATION_CLICK", // nombre del canal
        channelDescription: "description", // descripción del canal
