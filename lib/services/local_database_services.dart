...
import 'package:cliff_pickleball/providers/local_storage_provider.dart';
...
class LocalStorage {
  ...
  Future<Database> initializeDatabase() async {
    ...
    if (!storagePermissionResponse) {
      ...
      return Future.error("Storage Permission Denied");
    } else {
      final Directory? directory = await getExternalStorageDirectory();
      if (directory == null) {
        return Future.error("Could not access external storage directory");
      }
